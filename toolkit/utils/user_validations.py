                ...
                try:
                    ...
                    if (fSize % 16) != 0:
                        ...
                        print(
                            "!!!WARNING: the SIZE of "
                            + fPath
                            + " is NOT multiple of 16 bytes as required by MRAM"
                        )
                        if pad:
                            padlen = 16 - (fSize % 16)
                            print(
                                "Since the -p option was invoked, the binary will be padded with "
                                + str(padlen)
                                + " bytes"
                            )
                            ...
                            print(
                                "Please correct the image or use the -p option to pad the binary"
                            )
                            os._exit(1)
