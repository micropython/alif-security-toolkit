...
class KeyCertificateGenerator:
    ...
    def create_certificate(self):
        ...
        self._certificate = certificates.KeyArmCertificate(
...
def main(args):
    ...
    the_logger = util_logger.UtilLogger(
        the_argument_parser.log_filename, "Key Certificate Generation"
    )
    ...
    key_certificate_config = KeyCertificateConfig(
        the_argument_parser.cfg_filename, the_logger
    )
    # create certificate
    cert_creator = KeyCertificateGenerator(
        the_logger, key_certificate_config, cert_version
    )
