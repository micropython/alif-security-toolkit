...
class ContentCertificateGenerator:
    ...
    def create_certificate(self):
        ...
        self._certificate = certificates.ContentArmCertificate(
            self.config, self.cert_version, self.logger
        )
...
def main(args):
    ...
    the_logger = util_logger.UtilLogger(
        the_argument_parser.log_filename, "Content Certificate Generation"
    )
    ...
    cert_version = [
        project_config.getint("PROJ-CFG", "CERT_VERSION_MAJOR"),
        project_config.getint("PROJ-CFG", "CERT_VERSION_MINOR"),
    ]
    # get util configuration parameters
    content_certificate_config = ContentCertificateConfig(
        the_argument_parser.cfg_filename, the_logger
    )
    # create certificate
    cert_creator = ContentCertificateGenerator(
        the_logger, content_certificate_config, cert_version
    )
