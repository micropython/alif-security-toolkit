"""
Trace Flag Definitions and Lookup Tables for SEROM and SERAM
"""
...
TRACE_PLL_INIT_END = 0x43  # Important for frequency change
...
TRACE_STOP_7 = 0xBE
TRACE_STOP_8 = 0xBF
TRACE_BOOT_MRAM_ONLY = 0xC0
TRACE_BOOT_MRAM_OSPI = 0xC1
TRACE_BOOT_OSPI_ONLY = 0xC2
TRACE_PRIMARY_MRAM_BOOT = 0xC3
TRACE_PRIMARY_OSPI_BOOT = 0xC4
TRACE_SECONDARY_OSPI_BOOT = 0xC5
TRACE_OSPI_XIP_CFG = 0xC6
TRACE_OSPI_PINMUX_CFG = 0xC7
TRACE_OSPI_1_WOUNDING_CFG = 0xC8
TRACE_OSPI_CLK_CFG = 0xC9
TRACE_OSPI_CTRL_CFG = 0xCA
TRACE_OSPI_FLASH_DEVICE_CFG = 0xCB
TRACE_OSPI_WRITE_EN_CMD = 0xCC
TRACE_OSPI_FLASH_DEVICE_MODE_CMD = 0xCD
TRACE_OSPI_FLASH_DEVICE_WAIT_CYCLES_CMD = 0xCE
TRACE_OSPI_4BYTE_ADDR_MODE_CMD = 0xCF
TRACE_STOP_9 = 0xD0
TRACE_STOP_10 = 0xD1
TRACE_STOP_11 = 0xD2
TRACE_STOP_12 = 0xD3
...
TRACE_MISSING_TOC_OFFSET = 0xDE
TRACE_OSPI_CTRL_XIP_MODE_CFG = 0xDF
TRACE_OSPI_TX_ERR = 0xE0
TRACE_OSPI_OTP_VALID_STATUS = 0xE1
TRACE_ABORT_CONFIGURE_BOR = 0xE2
TRACE_BOR_NOT_ENABLED = 0xE3
TRACE_APPLY_BOR_THRESHOLD = 0xE4
TRACE_APPLY_BOR_HYSTERESIS = 0xE5
TRACE_WAIT_FOR_MRAM_READY = 0xE6
TRACE_FINISH_WAIT_FOR_MRAM_READY = 0xE7
TRACE_STANDBY_MODE = 0xE8

TRACE_MAINTENANCE_CHECK1 = 0xE9
TRACE_MAINTENANCE_CHECK2 = 0xEA
TRACE_MAINTENANCE_CHECK3 = 0xEB
TRACE_MAINTENANCE_SKIP_TRIM = 0xEC

TRACE_XTAL_START_DELAY_OVERRIDE = 0xED
TRACE_PLL_START_DELAY_OVERRIDE = 0xEE

# Marker trace translation
# Ensure all TRACE_* constants used as keys here are defined above
marker_lookup = {
    ...
    TRACE_FIREWALLS_INITIALIZED: "Firewalls initialized",
    ...
    TRACE_PLL_INIT_END: "PLL END",  # This string is used to detect CPU frequency change
    ...
    TRACE_STOC_PART_NUMBER: "TOC Part#",
    ...
    TRACE_PARTIAL_TRIMMING: "Partial trim specified",
    ...
    TRACE_TOGGLE_EXTSYS1_WAKEUP: "Toggle EXTSYS1 Wakeup",  # Value is 0x8B
    ...
    TRACE_FAST_BOOT: "FAST BOOT",  # Value is 0x8F
    ...
    TRACE_BOOT_MRAM_ONLY: "Boot FROM MRAM ONLY",
    TRACE_BOOT_MRAM_OSPI: "Boot from MRAM then OSPI",
    TRACE_BOOT_OSPI_ONLY: "Boot from OSPI only",
    TRACE_PRIMARY_MRAM_BOOT: "Primary MRAM boot",
    TRACE_PRIMARY_OSPI_BOOT: "Primary OSPI boot",
    TRACE_SECONDARY_OSPI_BOOT: "Secondary OSPI boot",
    TRACE_PINMUX: "PinMux",
    ...
    TRACE_MISSING_TOC_OFFSET: "Missing TOC Offset",
    TRACE_OSPI_XIP_CFG: "Start OSPI XIP configuration",
    TRACE_OSPI_PINMUX_CFG: "OSPI pinmux configuration",
    TRACE_OSPI_1_WOUNDING_CFG: "OSPI_1 wounding configuration",
    TRACE_OSPI_CLK_CFG: "OSPI clock configuration",
    TRACE_OSPI_CTRL_CFG: "OSPI controller settings",
    TRACE_OSPI_FLASH_DEVICE_CFG: "Flash device configuration",
    TRACE_OSPI_WRITE_EN_CMD: "Send write enable command",
    TRACE_OSPI_FLASH_DEVICE_MODE_CMD: "Send set flash device mode command",
    TRACE_OSPI_FLASH_DEVICE_WAIT_CYCLES_CMD: "Send set flash device wait cycles command",
    TRACE_OSPI_4BYTE_ADDR_MODE_CMD: "Send set 4 byte addressing mode command",
    TRACE_OSPI_CTRL_XIP_MODE_CFG: "Configure OSPI controller for XIP mode",
    TRACE_OSPI_TX_ERR: "OSPI controller transmit error",
    TRACE_OSPI_OTP_VALID_STATUS: "OSPI OTP configuration valid status",
    TRACE_ABORT_CONFIGURE_BOR: "Abort Configure Brownout",
    TRACE_BOR_NOT_ENABLED: "Brownout Not Enabled",
    TRACE_APPLY_BOR_THRESHOLD: "Configure Brownout Threshold",
    TRACE_APPLY_BOR_HYSTERESIS: "Configure Brownout Histeresis",
    TRACE_WAIT_FOR_MRAM_READY: "Wait for MRAM ready",
    TRACE_FINISH_WAIT_FOR_MRAM_READY: "Finish wait for MRAM ready",
    TRACE_STANDBY_MODE: "STANDBY MODE",
    TRACE_MAINTENANCE_CHECK1: "MAINTENANCE 1",
    TRACE_MAINTENANCE_CHECK2: "MAINTENANCE 2",
    TRACE_MAINTENANCE_CHECK3: "MAINTENANCE 3",
    TRACE_MAINTENANCE_SKIP_TRIM: "TRIM SKIPPED",
    TRACE_XTAL_START_DELAY_OVERRIDE: "XTAL start delay from ATOC",
    TRACE_PLL_START_DELAY_OVERRIDE: "PLL start delay from ATOC",
}

# Service ID lookup table
service_id_lut = {
