...
SEROM_OTP_READ_ERROR = 0x31
SEROM_NOT_IMPLEMENTED = 0x32
SEROM_UNCORRECTABLE = 0x33

SEROM_OSPI_WRITE_EN_TX_FAIL = 0x40
SEROM_OSPI_DEVICE_MODE_TX_FAIL = 0x41
SEROM_OSPI_WAIT_CYCLES_TX_FAIL = 0x42
SEROM_OSPI_4BYTE_ADDR_MODE_TX_FAIL = 0x43

SEROM_HARD_FAULT_ERROR = 0x50
