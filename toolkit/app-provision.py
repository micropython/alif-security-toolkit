...
def main():
    ...
    parser = argparse.ArgumentParser(description="APP Provision tool")
    parser.add_argument(
        "-d",
        "--discover",
        action="store_true",
        default=False,
        help="(isp) COM port discovery",
    )
    ...
    parser.add_argument(
        ...
        "--asset",
        type=str,
        help="APP Provision Assets (default assets: build/assets-app-cfg.bin)",
        default="build/assets-app-cfg.bin",
    )
    parser.add_argument(
